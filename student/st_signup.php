<?php
	...
	$sql="update student set strm_id=".$stream.", st_passout_year=".$passYear.", st_mobile=".$ph.", st_email='".$email."', st_password='".$pass_hash."', st_signup=1 where st_name='".$name."' and st_univ_roll=".$univRoll;
