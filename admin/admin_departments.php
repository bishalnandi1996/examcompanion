...
<div class="row" style="padding-left: 10px; padding-right: 10px;">
    <?php
        ...
        while($row=mysqli_fetch_assoc($result)) {
            echo "<div onclick='alert(\"Test\");' style='color: #7e2100; border: 2px solid #7e2100; margin-left: 10px; margin-top: 10px; padding: 5px; background: #dba564; font-weight: bold;'><h1 style='color: #ffffff;'><i class='fas fa-university'></i></h1>".$row['strm_name']."</div>";
        }
    ?>
</div>
